...
@section('content')
    ...
    <div class="bg-gray-900 min-h-screen p-6">
        <div class="text-center text-3xl text-white mt-5 mb-5">PINJAM RUANGAN FORM</div>
        ...
        <form action="{{ route('pinjam.ruangan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('peminjam.ruangan.index') }}" class="bg-blue-500 mt-6 px-4 py-2 rounded text-center text-white font-bold">KEMBALI</a>
