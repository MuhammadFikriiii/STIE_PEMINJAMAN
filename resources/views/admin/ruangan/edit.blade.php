...
@section('content')
    ...
    <div class="bg-gray-900 min-h-screen p-6">
        <div class="text-center text-3xl text-white mt-5 mb-5">EDIT RUANGAN</div>
        ...
        <form action="{{ route('admin.ruangan.update', $ruangan->id) }}" 
            ...
            <label class="text-white block mt-2">Nama Ruangan</label>
            <input type="text" name="nama_ruangan"
                value="{{ old('nama_ruangan', $ruangan->nama_ruangan) }}"
                class="w-full p-2 rounded" required>

            <label class="text-white mt-2 block">Status Ruangan</label>
            ...
            <label class="text-white mt-2 block">Foto Ruangan</label>
